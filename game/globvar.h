...
extern HCURSOR arrow_curs[3][3], sword_curs, key_curs, target_curs, talk_curs,
    look_curs;
...
extern short combat_posing_monster,
    current_working_monster; // 0-5 PC 100 + x - monster x
extern Boolean fast_bang;
extern short spec_item_array[60];
extern short overall_mode, current_spell_range;
extern Boolean first_update, anim_onscreen, frills_on, sys_7_avail,
...
extern short
    which_item_page[6]; // Remembers which of the 2 item pages pc looked at
extern short ulx, uly;
extern short
    display_mode; // 0 - center 1- ul 2 - ur 3 - dl 4 - dr 5 - small win
...
extern short monst_target[T_M]; // 0-5 target that pc   6 - no target  100 + x -
                                // target monster x
...
extern Boolean web, crate, barrel, fire_barrier, force_barrier, quickfire,
    force_wall, fire_wall, antimagic, scloud, ice_wall, blade_wall;
...
extern HFONT font, fantasy_font, small_bold_font, italic_font, underline_font,
    bold_font, tiny_font;
extern HBITMAP bmap;
...
extern short store_pre_talk_mode, store_personality, store_personality_graphic,
    shop_identify_cost;
...
extern short store_shop_min, store_shop_max, store_pre_shop_mode,
    store_cost_mult;
...
extern short remember_tiny_text; // Remembers what's in the tiny text-bar, to
                                 // prevent redrawing.
...
extern HBITMAP mixed_gworld, pc_stats_gworld, item_stats_gworld,
    text_area_gworld;
extern HBITMAP terrain_screen_gworld, text_bar_gworld, orig_text_bar_gworld,
    buttons_gworld;
extern HBITMAP items_gworld, tiny_obj_gworld, fields_gworld;
extern HBITMAP dlg_buttons_gworld, missiles_gworld, dlogpics_gworld,
    small_temp_gworld;
extern HBITMAP talking_portraits_gworld, frills_gworld, ter_anim_gworld,
...
extern RECT share_mess_source_rect, share_mess_rect;
extern RECT start_buttons_source_rect, start_buttons_rect; /**/
...
extern short store_str_label_1, store_str_label_2, store_str_label_1b,
    store_str_label_2b;

// Misc dialog vars
extern short store_display_mode, store_displayed_item, position, cur_entry,
...
extern short first_item_shown, store_get_mode, current_getting_pc, store_pcnum,
...
extern short
    current_pc_picked_in_spec_enc; // pc that's been selected, -1 if none
