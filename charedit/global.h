...
#define DOOR_LIGHT                                                             \
  can_enter = run_trap(7, &PSD[c_town.town_num][which], 4220, 0);              \
  break;
#define DOOR_HEAVY                                                             \
  can_enter = run_trap(7, &PSD[c_town.town_num][which], 4220, 20);             \
  break;
#define DOOR_ALARM                                                             \
  can_enter = run_trap(7, &PSD[c_town.town_num][which], 4220, 11);             \
  break;
#define DRESSER_LIGHT                                                          \
  can_enter = run_trap(7, &PSD[c_town.town_num][which], 4221, 0);              \
  break;
#define DRESSER_HEAVY                                                          \
  can_enter = run_trap(7, &PSD[c_town.town_num][which], 4221, 20);             \
  break;
#define DRESSER_ALARM                                                          \
  can_enter = run_trap(7, &PSD[c_town.town_num][which], 4221, 11);             \
  break;
#define FLOOR_LIGHT                                                            \
  can_enter = run_trap(7, &PSD[c_town.town_num][which], 4222, 0);              \
  break;
#define FLOOR_HEAVY                                                            \
  can_enter = run_trap(7, &PSD[c_town.town_num][which], 4222, 20);             \
  break;
#define FLOOR_ALARM                                                            \
  can_enter = run_trap(7, &PSD[c_town.town_num][which], 4222, 11);             \
  break;
#define CHEST_LIGHT                                                            \
  can_enter = run_trap(7, &PSD[c_town.town_num][which], 3450, 0);              \
  break;
#define CHEST_HEAVY                                                            \
  can_enter = run_trap(7, &PSD[c_town.town_num][which], 3450, 20);             \
  break;
#define CHEST_ALARM                                                            \
  can_enter = run_trap(7, &PSD[c_town.town_num][which], 3450, 11);             \
  break;
...
typedef struct {
  short picture;
  unsigned char blockage, flag1, flag2, special, trans_to_what, fly_over,
      boat_over;
  unsigned char block_horse, light_radius, step_sound, shortcut_key, res1, res2,
      res3;
} terrain_type_type;
...
typedef struct {
  ...
  short a[3];
  unsigned char a1_type, a23_type, m_type, speed, ap, mu, cl, breath,
      breath_type, treasure, spec_skill, poison;
  ...
  unsigned char default_attitude, summon_type, default_facial_pic, res1, res2,
      res3;
  short picture_num;
